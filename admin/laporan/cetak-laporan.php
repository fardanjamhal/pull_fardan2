    ...
    if(isset($_GET['filter']) && ! empty($_GET['filter'])){
      ...
      if($filter == '1'){
        ...
        $query = "SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.desa, surat_keterangan.no_surat, surat_keterangan.tanggal_surat, surat_keterangan.jenis_surat FROM penduduk LEFT JOIN surat_keterangan ON surat_keterangan.nik = penduduk.nik WHERE surat_keterangan.status_surat='selesai' AND DATE(surat_keterangan.tanggal_surat)='{$_GET['tanggal']}'
          ...
          UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.desa, surat_keterangan_kematian.no_surat, surat_keterangan_kematian.tanggal_surat, surat_keterangan_kematian.jenis_surat FROM penduduk LEFT JOIN surat_keterangan_kematian ON surat_keterangan_kematian.nik = penduduk.nik WHERE surat_keterangan_kematian.status_surat='selesai' AND DATE(surat_keterangan_kematian.tanggal_surat)='{$_GET['tanggal']}'
          UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.desa, surat_keterangan_domisili_usaha.no_surat, surat_keterangan_domisili_usaha.tanggal_surat, surat_keterangan_domisili_usaha.jenis_surat FROM penduduk LEFT JOIN surat_keterangan_domisili_usaha ON surat_keterangan_domisili_usaha.nik = penduduk.nik WHERE surat_keterangan_domisili_usaha.status_surat='selesai' AND DATE(surat_keterangan_domisili_usaha.tanggal_surat)='{$_GET['tanggal']}'
          UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.desa, surat_keterangan_pengantar.no_surat, surat_keterangan_pengantar.tanggal_surat, surat_keterangan_pengantar.jenis_surat FROM penduduk LEFT JOIN surat_keterangan_pengantar ON surat_keterangan_pengantar.nik = penduduk.nik WHERE surat_keterangan_pengantar.status_surat='selesai' AND DATE(surat_keterangan_pengantar.tanggal_surat)='{$_GET['tanggal']}'
        ...
        $query = "SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.desa, surat_keterangan.no_surat, surat_keterangan.tanggal_surat, surat_keterangan.jenis_surat FROM penduduk LEFT JOIN surat_keterangan ON surat_keterangan.nik = penduduk.nik WHERE surat_keterangan.status_surat='selesai' AND MONTH(surat_keterangan.tanggal_surat)='{$_GET['bulan']}' AND YEAR(surat_keterangan.tanggal_surat)='{$_GET['tahun']}'
          ...
          UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.desa, surat_keterangan_kematian.no_surat, surat_keterangan_kematian.tanggal_surat, surat_keterangan_kematian.jenis_surat FROM penduduk LEFT JOIN surat_keterangan_kematian ON surat_keterangan_kematian.nik = penduduk.nik WHERE surat_keterangan_kematian.status_surat='selesai' AND MONTH(surat_keterangan_kematian.tanggal_surat)='{$_GET['bulan']}' AND YEAR(surat_keterangan_kematian.tanggal_surat)='{$_GET['tahun']}'
          UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.desa, surat_keterangan_domisili_usaha.no_surat, surat_keterangan_domisili_usaha.tanggal_surat, surat_keterangan_domisili_usaha.jenis_surat FROM penduduk LEFT JOIN surat_keterangan_domisili_usaha ON surat_keterangan_domisili_usaha.nik = penduduk.nik WHERE surat_keterangan_domisili_usahan.status_surat='selesai' AND MONTH(surat_keterangan_domisili_usaha.tanggal_surat)='{$_GET['bulan']}' AND YEAR(surat_keterangan_domisili_usaha.tanggal_surat)='{$_GET['tahun']}'
          UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.desa, surat_keterangan_pengantar.no_surat, surat_keterangan_pengantar.tanggal_surat, surat_keterangan_pengantar.jenis_surat FROM penduduk LEFT JOIN surat_keterangan_pengantar ON surat_keterangan_pengantar.nik = penduduk.nik WHERE surat_keterangan_pengantar.status_surat='selesai' AND MONTH(surat_keterangan_pengantar.tanggal_surat)='{$_GET['bulan']}' AND YEAR(surat_keterangan_pengantar.tanggal_surat)='{$_GET['tahun']}'
        ...
        $query = "SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.desa, surat_keterangan.no_surat, surat_keterangan.tanggal_surat, surat_keterangan.jenis_surat FROM penduduk LEFT JOIN surat_keterangan ON surat_keterangan.nik = penduduk.nik WHERE surat_keterangan.status_surat='selesai' AND YEAR(surat_keterangan.tanggal_surat)='{$_GET['tahun']}'
          ...
          UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.desa, surat_keterangan_kematian.no_surat, surat_keterangan_kematian.tanggal_surat, surat_keterangan_kematian.jenis_surat FROM penduduk LEFT JOIN surat_keterangan_kematian ON surat_keterangan_kematian.nik = penduduk.nik WHERE surat_keterangan_kematian.status_surat='selesai' AND YEAR(surat_keterangan_kematian.tanggal_surat)='{$_GET['tahun']}' 
          UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.desa, surat_keterangan_domisili_usaha.no_surat, surat_keterangan_domisili_usaha.tanggal_surat, surat_keterangan_domisili_usaha.jenis_surat FROM penduduk LEFT JOIN surat_keterangan_domisili_usaha ON surat_keterangan_domisili_usaha.nik = penduduk.nik WHERE surat_keterangan_domisili_usaha.status_surat='selesai' AND YEAR(surat_keterangan_domisili_usaha.tanggal_surat)='{$_GET['tahun']}' 
          UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.desa, surat_keterangan_pengantar.no_surat, surat_keterangan_pengantar.tanggal_surat, surat_keterangan_pengantar.jenis_surat FROM penduduk LEFT JOIN surat_keterangan_pengantar ON surat_keterangan_pengantar.nik = penduduk.nik WHERE surat_keterangan_pengantar.status_surat='selesai' AND YEAR(surat_keterangan_pengantar.tanggal_surat)='{$_GET['tahun']}' 
