       ...
       <style>
        ...
        <table class="table table-borderless" style="width: 100%;">
          <colgroup>
            ...
            <col style="width: 2%;">  <!-- Tanda ":" -->
            <col style="width: 68%;"> <!-- Nilai -->
          </colgroup>

          <tr><td>Nama Bayi</td><td>:</td><td><?= nl2br($data['nama_bayi']) ?></td></tr>
          <tr><td>Tempat, Tanggal Lahir</td><td>:</td><td><?= nl2br($data['ttl_bayi']) ?></td></tr>
          <tr><td>Jenis Kelamin</td><td>:</td><td><?= nl2br($data['jenis_kelamin']) ?></td></tr>
          <tr><td>Agama</td><td>:</td><td><?= nl2br($data['agama']) ?></td></tr>
          <tr><td>Alamat</td><td>:</td><td><?= nl2br($data['alamat']) ?></td></tr>
          <tr><td>Nama Ayah</td><td>:</td><td><?= nl2br($data['nama_ayah']) ?></td></tr>
          <tr><td>Nama Ibu</td><td>:</td><td><?= nl2br($data['nama_ibu']) ?></td></tr>
        </table>
