...
mysqli_query($connect, "UPDATE formulir_surat_izin_orang_tua SET tanggal_surat = NOW() WHERE id_fsiot = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM formulir_surat_izin_orang_tua WHERE id_fsiot = $id");
...
$folder_name = basename(__DIR__); // contoh: formulir_surat_izin_orang_tua
...
$qUpdate = "
    UPDATE formulir_surat_izin_orang_tua 
