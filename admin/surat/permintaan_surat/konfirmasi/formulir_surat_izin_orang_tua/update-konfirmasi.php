<?php
	...
	$qCek = "SELECT * FROM formulir_surat_izin_orang_tua WHERE no_surat = '$no_surat' AND id_fsiot != '$id'";
	...
	$qUpdate 	= "UPDATE formulir_surat_izin_orang_tua SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_fsiot='$id'";
