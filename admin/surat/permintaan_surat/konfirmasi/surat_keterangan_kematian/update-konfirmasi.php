...
mysqli_query($connect, "UPDATE surat_keterangan_kematian SET tanggal_surat = NOW() WHERE id_skk = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_keterangan_kematian WHERE id_skk = $id");
...
$folder_name = basename(__DIR__); // contoh: surat_keterangan_kematian
...
$qUpdate = "
    UPDATE surat_keterangan_kematian 
