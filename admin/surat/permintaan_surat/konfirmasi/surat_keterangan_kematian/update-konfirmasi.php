<?php
	...
	$qCek = "SELECT * FROM surat_keterangan_kematian WHERE no_surat = '$no_surat' AND id_skk != '$id'";
	...
	$qUpdate 	= "UPDATE surat_keterangan_kematian SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_skk='$id'";
