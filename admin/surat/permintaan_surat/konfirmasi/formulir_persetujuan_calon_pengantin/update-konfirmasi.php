<?php
	...
	$qCek = "SELECT * FROM formulir_persetujuan_calon_pengantin WHERE no_surat = '$no_surat' AND id_fpcp != '$id'";
	...
	$qUpdate 	= "UPDATE formulir_persetujuan_calon_pengantin SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_fpcp='$id'";
