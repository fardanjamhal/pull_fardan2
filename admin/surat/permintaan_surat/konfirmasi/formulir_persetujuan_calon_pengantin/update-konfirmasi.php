...
mysqli_query($connect, "UPDATE formulir_persetujuan_calon_pengantin SET tanggal_surat = NOW() WHERE id_fpcp = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM formulir_persetujuan_calon_pengantin WHERE id_fpcp = $id");
...
$folder_name = basename(__DIR__); // contoh: formulir_persetujuan_calon_pengantin
...
$qUpdate = "
    UPDATE formulir_persetujuan_calon_pengantin 
