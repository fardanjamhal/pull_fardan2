<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect,"SELECT penduduk.*, formulir_persetujuan_calon_pengantin.* FROM penduduk LEFT JOIN formulir_persetujuan_calon_pengantin ON formulir_persetujuan_calon_pengantin.nik = penduduk.nik WHERE formulir_persetujuan_calon_pengantin.id_fpcp='$id'");
      ...
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Formulir Persetujuan Calon Pengantin</h2>
            ...
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_fpcpkkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_fpcp']) ? (int)$row['id_fpcp'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_fpcpkkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM formulir_persetujuan_calon_pengantin
                              WHERE id_fpcp < $current_id 
                              ORDER BY id_fpcp DESC 
                              LIMIT 1
                          ");
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_fpcp']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
