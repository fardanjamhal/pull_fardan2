              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_skukkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_sku']) ? (int)$row['id_sku'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_skukkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_keterangan_usaha
                              WHERE id_sku < $current_id 
                              ORDER BY id_sku DESC 
                              LIMIT 1
                          ");
