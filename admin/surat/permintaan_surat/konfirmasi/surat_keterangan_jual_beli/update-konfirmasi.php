<?php
	...
	$qCek = "SELECT * FROM surat_keterangan_jual_beli WHERE no_surat = '$no_surat' AND id_skjb != '$id'";
	...
	$qUpdate 	= "UPDATE surat_keterangan_jual_beli SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_skjb='$id'";
