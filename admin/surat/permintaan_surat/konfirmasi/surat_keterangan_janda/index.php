      ...
      <div class="modal-body">
       ...
       <style>
        ...
        <table class="table" style="width: 100%;">
          ...
          <tr><td>Nama Suami</td><td>:</td><td><?= nl2br($data['nama_pasangan']) ?></td></tr>
          <tr><td>Penyebab Janda</td><td>:</td><td><?= nl2br($data['alasan_pisah']) ?></td></tr>
          <tr><td>Keterangan Tambahan</td><td>:</td><td><?= nl2br($data['keterangan_tambahan']) ?></td></tr>
