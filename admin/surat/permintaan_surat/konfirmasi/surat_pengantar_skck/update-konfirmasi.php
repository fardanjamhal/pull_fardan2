...
mysqli_query($connect, "UPDATE surat_pengantar_skck SET tanggal_surat = NOW() WHERE id_sps = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_pengantar_skck WHERE id_sps = $id");
...
$folder_name = basename(__DIR__); // contoh: surat_pengantar_skck
