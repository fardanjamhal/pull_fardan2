              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_skbiskkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_skbis']) ? (int)$row['id_skbis'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_skbiskkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_keterangan_beda_identitas_kis 
                              WHERE id_skbis < $current_id 
                              ORDER BY id_skbis DESC 
                              LIMIT 1
                          ");
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fno_kartu" style="text-transform: uppercase;" value="<?php echo $row['no_kartu']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Nama di Kartu</label>
                      <div class="col-sm-9">
                        <input type="text" name="fnama_di_kartu" style="text-transform: uppercase;" value="<?php echo $row['nama_di_kartu']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="box-body">
                    ...
                    <br><br>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="ftanggal_lahir" style="text-transform: uppercase;" value="<?php echo $row['tanggal_lahir']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Faskes Tingkat I</label>
                      <div class="col-sm-9">
                        <input type="text" name="ffaskes_tingkat" style="text-transform: uppercase;" value="<?php echo $row['faskes_tingkat']; ?>" class="form-control" readonly>
                      </div>
                    </div>
             
                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_skbis']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
