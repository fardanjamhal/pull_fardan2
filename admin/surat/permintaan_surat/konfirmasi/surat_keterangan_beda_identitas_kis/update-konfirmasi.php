...
mysqli_query($connect, "UPDATE surat_keterangan_beda_identitas_kis SET tanggal_surat = NOW() WHERE id_skbis = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_keterangan_beda_identitas_kis WHERE id_skbis = $id");
...
$folder_name = basename(__DIR__); // contoh: surat_keterangan_beda_identitas_kis
...
$qUpdate = "
    UPDATE surat_keterangan_beda_identitas_kis 
