<?php
	...
	$qCek = "SELECT * FROM surat_keterangan_beda_identitas_kis WHERE no_surat = '$no_surat' AND id_skbis != '$id'";
	...
	$qUpdate 	= "UPDATE surat_keterangan_beda_identitas_kis SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_skbis='$id'";
