<?php
	...
	$qCek = "SELECT * FROM surat_pengantar_hewan WHERE no_surat = '$no_surat' AND id_sph != '$id'";
	...
	$qUpdate 	= "UPDATE surat_pengantar_hewan SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_sph='$id'";
