<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect,"SELECT penduduk.*, surat_pengantar_hewan.* FROM penduduk LEFT JOIN surat_pengantar_hewan ON surat_pengantar_hewan.nik = penduduk.nik WHERE surat_pengantar_hewan.id_sph='$id'");
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_sphkkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_sph']) ? (int)$row['id_sph'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_sphkkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_pengantar_hewan 
                              WHERE id_sph < $current_id 
                              ORDER BY id_sph DESC 
                              LIMIT 1
                          ");
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <br>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Nama Hewan</label>
                      <div class="col-sm-9">
                        <input type="text" name="fnama_hewan" style="text-transform: uppercase;" value="<?php echo $row['nama_hewan']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Jenis Kelamin</label>
                      <div class="col-sm-9">
                        <input type="text" name="fjenis_kelamin_hewan" style="text-transform: uppercase;" value="<?php echo $row['jenis_kelamin_hewan']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Umur</label>
                      <div class="col-sm-9">
                        <input type="text" name="fumur" style="text-transform: uppercase;" value="<?php echo $row['umur']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Warna Bulu</label>
                      <div class="col-sm-9">
                        <input type="text" name="fwarna_bulu" style="text-transform: uppercase;" value="<?php echo $row['warna_bulu']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <br><br>
                     <div class="form-group">
                      <label class="col-sm-3 control-label">Tanduk</label>
                      <div class="col-sm-9">
                        <input type="text" name="ftanduk" style="text-transform: uppercase;" value="<?php echo $row['tanduk']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                     <div class="form-group">
                      <label class="col-sm-3 control-label">Tujuan</label>
                      <div class="col-sm-9">
                        <input type="text" name="ftujuan style="text-transform: uppercase;" value="<?php echo $row['tujuan']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                     <div class="form-group">
                      <label class="col-sm-3 control-label">Untuk</label>
                      <div class="col-sm-9">
                        <input type="text" name="funtuk" style="text-transform: uppercase;" value="<?php echo $row['untuk']; ?>" class="form-control" readonly>
                      </div>
                    </div>
             
                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_sph']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
