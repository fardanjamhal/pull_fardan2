                ...
                <div class="col-md-6">
                  ...
                  <!-- FARDAN SALIN NOMOR OTOMATIS -->
                    ...
                    $q_surat = mysqli_query($connect, "
                      ...
                      FROM nomor_surat ns
                      JOIN surat_keterangan_domisili_usaha id_skdu 
                        ON id_skdu.no_surat = ns.nomor_lengkap
                      ORDER BY ns.id DESC 
                      LIMIT 1
                    ");
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="falamat_usaha" style="text-transform: uppercase;" value="<?php echo $row['alamat_usaha']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fjenis_usaha" style="text-transform: uppercase;" value="<?php echo $row['jenis_usaha']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_skdu']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
