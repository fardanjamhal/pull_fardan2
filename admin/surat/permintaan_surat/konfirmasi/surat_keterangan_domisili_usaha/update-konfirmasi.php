<?php
	...
	$qCek = "SELECT * FROM surat_keterangan_domisili_usaha WHERE no_surat = '$no_surat' AND id_skdu != '$id'";
	...
	$qUpdate 	= "UPDATE surat_keterangan_domisili_usaha SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_skdu='$id'";
