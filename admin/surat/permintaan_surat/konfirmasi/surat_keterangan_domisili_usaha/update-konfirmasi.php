...
mysqli_query($connect, "UPDATE surat_keterangan_domisili_usaha SET tanggal_surat = NOW() WHERE id_skdu = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_keterangan_domisili_usaha WHERE id_skdu = $id");
...
$folder_name = basename(__DIR__); // contoh: surat_keterangan_domisili_usaha
...
$qUpdate = "
    UPDATE surat_keterangan_domisili_usaha 
