              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <!-- FARDAN SALIN NOMOR OTOMATIS -->
                    <?php
                      // Ambil id_skkkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_skp']) ? (int)$row['id_skp'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_skkkb yang kurang dari current_id
