...
mysqli_query($connect, "UPDATE surat_keterangan_perhiasan SET tanggal_surat = NOW() WHERE id_skp = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_keterangan_perhiasan WHERE id_skp = $id");
...
$folder_name = basename(__DIR__); // contoh: surat_keterangan_perhiasan
