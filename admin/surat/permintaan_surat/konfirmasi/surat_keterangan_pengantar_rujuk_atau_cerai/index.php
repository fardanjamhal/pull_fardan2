              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_skrckkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_skrc']) ? (int)$row['id_skrc'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_skrckkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_keterangan_pengantar_rujuk_atau_cerai 
                              WHERE id_skrc < $current_id 
                              ORDER BY id_skrc DESC 
                              LIMIT 1
                          ");
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        ?>
          <table class="table">
            <tr><td>Bin</td><td><?php echo $data['bin']; ?></td></tr>
            <tr><td>Nama Lengkap</td><td><?php echo $data['nama2']; ?></td></tr>
            <tr><td>Binti</td><td><?php echo $data['binti2']; ?></td></tr>
            <tr><td>Tempat / Tgl Lahir</td><td><?php echo $data['tempat_tgl_lahir2']; ?></td></tr>
            <tr><td>Kewarganegaraan</td><td><?php echo $data['kewarganegaraan2']; ?></td></tr>
            <tr><td>Agama</td><td><?php echo $data['agama2']; ?></td></tr>
            <tr><td>Pekerjaan</td><td><?php echo $data['pekerjaan2']; ?></td></tr>
