<?php
	...
	$qCek = "SELECT * FROM surat_keterangan_pengantar_rujuk_atau_cerai WHERE no_surat = '$no_surat' AND id_skrc != '$id'";
	...
	$qUpdate 	= "UPDATE surat_keterangan_pengantar_rujuk_atau_cerai SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_skrc='$id'";
