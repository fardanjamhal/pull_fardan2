              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_sktmkkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_sktm']) ? (int)$row['id_sktm'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_sktmkkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_keterangan_tidak_mampu
                              WHERE id_sktm < $current_id 
                              ORDER BY id_sktm DESC 
                              LIMIT 1
                          ");
