...
mysqli_query($connect, "UPDATE surat_keterangan_pindah_penduduk SET tanggal_surat = NOW() WHERE id_skpp = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_keterangan_pindah_penduduk WHERE id_skpp = $id");
...
$folder_name = basename(__DIR__); // contoh: surat_keterangan_pindah_penduduk
...
$qUpdate = "
    UPDATE surat_keterangan_pindah_penduduk 
