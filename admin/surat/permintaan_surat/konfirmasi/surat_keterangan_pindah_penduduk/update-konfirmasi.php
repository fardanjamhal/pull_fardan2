<?php
	...
	$qCek = "SELECT * FROM surat_keterangan_pindah_penduduk WHERE no_surat = '$no_surat' AND id_skpp != '$id'";
	...
	$qUpdate 	= "UPDATE surat_keterangan_pindah_penduduk SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_skpp='$id'";
