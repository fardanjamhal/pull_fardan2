              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_skppkkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_skpp']) ? (int)$row['id_skpp'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_skppkkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_keterangan_pindah_penduduk 
                              WHERE id_skpp < $current_id 
                              ORDER BY id_skpp DESC 
                              LIMIT 1
                          ");
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                       <!-- Untuk Bootstrap 4 -->
                        <button type="button" class="btn btn-primary btn-sm text-white" data-toggle="modal" data-target="#modalFormulir_<?php echo $row['id_skpp']; ?>">
                        Lihat Data Formulir
                      </button>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_skpp']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
...
<!-- Modal -->
<div class="modal fade" id="modalFormulir_<?php echo $row['id_skpp']; ?>" tabindex="-1">
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php
          // Cek lagi id_skpp ini
          $id_skpp = $row['id_skpp'];
          $query = mysqli_query($connect, "SELECT * FROM surat_keterangan_pindah_penduduk WHERE id_skpp = '$id_skpp'");
          $data = mysqli_fetch_assoc($query);

          if ($data) {
        ?>
          <table class="table">
            <tr><td>Alamat Tujuan</td><td><?php echo $data['alamat_yang_dituju']; ?></td></tr>
            <tr><td>Alasan Pindah</td><td><?php echo $data['alasan_pindah']; ?></td></tr>
            <tr><td>Tanggal Pindah</td><td><?php echo $data['tanggal_pindah']; ?></td></tr>
            <tr><td>Jumlah Pengikut</td><td><?php echo $data['jumlah_pengikut_display']; ?></td></tr>
          </table>
        <?php
          } else {
