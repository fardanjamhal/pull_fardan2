              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_skbikkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_skbi']) ? (int)$row['id_skbi'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_skbikkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_keterangan_beda_identitas 
                              WHERE id_skbi < $current_id 
                              ORDER BY id_skbi DESC 
                              LIMIT 1
                          ");
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fnama_kartu_identitas" style="text-transform: uppercase;" value="<?php echo $row['nama_kartu_identitas']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Nomor Identitas</label>
                      <div class="col-sm-9">
                        <input type="text" name="fnama_no_identitas" style="text-transform: uppercase;" value="<?php echo $row['nama_no_identitas']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Nama Identitas</label>
                      <div class="col-sm-9">
                        <input type="text" name="fnama2" style="text-transform: uppercase;" value="<?php echo $row['nama2']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Alamat Identitas</label>
                      <div class="col-sm-9">
                  ...
                  <div class="box-body">
                    ...
                    <br><br>
                     <div class="form-group">
                      <label class="col-sm-3 control-label">Tempat / Tgl Lahir</label>
                      <div class="col-sm-9">
                        <input type="text" name="ftgl_lahir2" style="text-transform: uppercase;" value="<?php echo $row['nama2']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Jenis Kelamin</label>
                      <div class="col-sm-9">
                        <input type="text" name="fjenis_kelamin2" style="text-transform: uppercase;" value="<?php echo $row['nama2']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Agama</label>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fketerangan2" style="text-transform: uppercase;" value="<?php echo $row['keterangan2']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Terdapat Perbedaan Pada</label>
                      <div class="col-sm-9">
                        <input type="text" name="fperbedaan" style="text-transform: uppercase;" value="<?php echo $row['perbedaan']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_skbi']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
