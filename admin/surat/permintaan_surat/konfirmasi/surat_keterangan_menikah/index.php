  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <tr>
            <td style="width: 160px; vertical-align: top; white-space: nowrap;">
                <div style="display: flex; justify-content: space-between;">
                    <span>Nama Pelapor</span><span>:</span>
                </div>
            </td>
            <td style="padding-left: 6px;"><?php echo htmlspecialchars($data['nama_pelapor']); ?></td>
        </tr>

        <tr>
            <td style="width: 160px; vertical-align: top; white-space: nowrap;">
                <div style="display: flex; justify-content: space-between;">
                    <span>NIK Pelapor</span><span>:</span>
                </div>
            </td>
            <td style="padding-left: 6px;"><?php echo htmlspecialchars($data['nik_pelapor']); ?></td>
        </tr>
        ...
        <tr>
            ...
            <td style="padding-left: 6px;"><?php echo date('d-m-Y', strtotime($data['tanggal_lahir_pelapor'])); ?></td>
        </tr>

        <tr>
            <td style="width: 160px; vertical-align: top; white-space: nowrap;">
                <div style="display: flex; justify-content: space-between;">
                    <span>Pekerjaan</span><span>:</span>
                </div>
            </td>
            <td style="padding-left: 6px;"><?php echo htmlspecialchars($data['pekerjaan_pelapor']); ?></td>
        </tr>
        ...
        <tr>
            ...
            <td style="padding-left: 6px;"><?php echo htmlspecialchars($data['jenis_kelamin_pelapor']); ?></td>
        </tr>
        ...
        <tr>
            ...
            <td style="padding-left: 6px;"><?php echo nl2br(htmlspecialchars($data['alamat_pelapor'])); ?></td>
        </tr>
