<?php
	...
	$qCek = "SELECT * FROM surat_keterangan_mahar_sunrang WHERE no_surat = '$no_surat' AND id_skm != '$id'";
	...
	$qUpdate 	= "UPDATE surat_keterangan_mahar_sunrang SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_skm='$id'";
