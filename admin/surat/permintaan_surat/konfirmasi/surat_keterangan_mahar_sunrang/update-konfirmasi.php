...
mysqli_query($connect, "UPDATE surat_keterangan_mahar_sunrang SET tanggal_surat = NOW() WHERE id_skm = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_keterangan_mahar_sunrang WHERE id_skm = $id");
...
$folder_name = basename(__DIR__); // contoh: surat_keterangan_mahar_sunrang
...
$qUpdate = "
    UPDATE surat_keterangan_mahar_sunrang 
