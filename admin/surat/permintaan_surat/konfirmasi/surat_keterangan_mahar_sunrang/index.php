              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_skmkkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_skm']) ? (int)$row['id_skm'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_skmkkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_keterangan_mahar_sunrang 
                              WHERE id_skm < $current_id 
                              ORDER BY id_skm DESC 
                              LIMIT 1
                          ");
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        ?>
          <table class="table">
            <tr><td>Mahar :</td><td><?php echo $data['mahar']; ?></td></tr>
            <tr><td>Tempat / Lokasi :</td><td><?php echo $data['tempat_mahar']; ?></td></tr>
            <tr><td>SEBELAH UTARA :</td><td><?php echo $data['tanah_utara']; ?></td></tr>
            <tr><td>SEBELAH TIMUR :</td><td><?php echo $data['tanah_timur']; ?></td></tr>
            <tr><td>SEBELAH SELATAN :</td><td><?php echo $data['tanah_selatan']; ?></td></tr>
            <tr><td>SEBELAH BARAT :</td><td><?php echo $data['tanah_barat']; ?></td></tr>
            <tr><td>NAMA Orang Tua :</td><td><?php echo $data['orang_tua']; ?></td></tr>
            <tr><td>Tempat / Tanggal Lahir :</td><td><?php echo $data['tempat_tgl_lahir2']; ?></td></tr>
            <tr><td>ALAMAT :</td><td><?php echo $data['alamat2']; ?></td></tr>
            <tr><td>NAMA PASANGAN :</td><td><?php echo $data['perempuan']; ?></td></tr>
            <tr><td>Tempat / Tanggal Lahir :</td><td><?php echo $data['tempat_tgl_lahir3']; ?></td></tr>
            <tr><td>ALAMAT :</td><td><?php echo $data['alamat3']; ?></td></tr>
            <tr><td>SAKSI 1 :</td><td><?php echo $data['saksi1']; ?></td></tr>
            <tr><td>SAKSI 2 :</td><td><?php echo $data['saksi2']; ?></td></tr>
          </table>
        <?php
          } else {
