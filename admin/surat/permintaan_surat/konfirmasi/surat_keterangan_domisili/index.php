              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_skdkkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_skd']) ? (int)$row['id_skd'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_skdkkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_keterangan_domisili 
                              WHERE id_skd < $current_id 
                              ORDER BY id_skd DESC 
                              LIMIT 1
                          ");
