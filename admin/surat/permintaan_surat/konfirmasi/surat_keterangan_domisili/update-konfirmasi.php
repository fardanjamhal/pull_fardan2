...
mysqli_query($connect, "UPDATE surat_keterangan_domisili SET tanggal_surat = NOW() WHERE id_skd = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_keterangan_domisili WHERE id_skd = $id");
...
$folder_name = basename(__DIR__); // contoh: surat_keterangan_domisili
