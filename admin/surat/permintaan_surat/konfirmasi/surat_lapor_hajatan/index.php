              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_slhkkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_slh']) ? (int)$row['id_slh'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_slhkkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_lapor_hajatan
                              WHERE id_slh < $current_id 
                              ORDER BY id_slh DESC 
                              LIMIT 1
                          ");
