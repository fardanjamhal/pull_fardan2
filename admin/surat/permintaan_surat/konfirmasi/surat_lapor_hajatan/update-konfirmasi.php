...
mysqli_query($connect, "UPDATE surat_lapor_hajatan SET tanggal_surat = NOW() WHERE id_slh = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_lapor_hajatan WHERE id_slh = $id");
...
$folder_name = basename(__DIR__); // contoh: surat_lapor_hajatan
