              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_skbtspkkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_skbtsp']) ? (int)$row['id_skbtsp'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_skbtspkkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_keterangan_belum_terbit_sppt_pbb 
                              WHERE id_skbtsp < $current_id 
                              ORDER BY id_skbtsp DESC 
                              LIMIT 1
                          ");
