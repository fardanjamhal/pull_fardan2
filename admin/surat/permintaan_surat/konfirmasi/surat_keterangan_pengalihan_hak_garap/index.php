      ...
      <div class="modal-body">
       ...
       <style>
        ...
        <table class="table" style="width: 100%;">
         <tr><td>Isi Surat</td><td>:</td><td><?= htmlspecialchars($data['isi_surat']) ?></td></tr>
        <tr><td>Sebelah Utara</td><td>:</td><td><?= htmlspecialchars($data['tanah_utara']) ?></td></tr>
        <tr><td>Sebelah Timur</td><td>:</td><td><?= htmlspecialchars($data['tanah_timur']) ?></td></tr>
        <tr><td>Sebelah Selatan</td><td>:</td><td><?= htmlspecialchars($data['tanah_selatan']) ?></td></tr>
        <tr><td>Sebelah Barat</td><td>:</td><td><?= htmlspecialchars($data['tanah_barat']) ?></td></tr>

        <tr><td>NIK Pihak Kedua</td><td>:</td><td><?= htmlspecialchars($data['nik2']) ?></td></tr>
        <tr><td>Nama</td><td>:</td><td><?= htmlspecialchars($data['nama2']) ?></td></tr>
        <tr><td>Tempat / Tgl Lahir</td><td>:</td><td><?= htmlspecialchars($data['tempat_tgl_lahir2']) ?></td></tr>
        <tr><td>Pekerjaan</td><td>:</td><td><?= htmlspecialchars($data['pekerjaan2']) ?></td></tr>
        <tr><td>Alamat</td><td>:</td><td><?= htmlspecialchars($data['alamat2']) ?></td></tr>

        <tr><td>Isi Surat Kedua</td><td>:</td><td><?= htmlspecialchars($data['isi_surat2']) ?></td></tr>

        <tr><td>Nama Saksi 1</td><td>:</td><td><?= htmlspecialchars($data['nama_saksi1']) ?></td></tr>
        <tr><td>Umur Saksi 1</td><td>:</td><td><?= htmlspecialchars($data['umur_saksi1']) ?></td></tr>
        <tr><td>Alamat Saksi 1</td><td>:</td><td><?= htmlspecialchars($data['alamat_saksi1']) ?></td></tr>
        <tr><td>Pekerjaan Saksi 1</td><td>:</td><td><?= htmlspecialchars($data['pekerjaan_saksi1']) ?></td></tr>

        <tr><td>Nama Saksi 2</td><td>:</td><td><?= htmlspecialchars($data['nama_saksi2']) ?></td></tr>
        <tr><td>Umur Saksi 2</td><td>:</td><td><?= htmlspecialchars($data['umur_saksi2']) ?></td></tr>
        <tr><td>Alamat Saksi 2</td><td>:</td><td><?= htmlspecialchars($data['alamat_saksi2']) ?></td></tr>
        <tr><td>Pekerjaan Saksi 2</td><td>:</td><td><?= htmlspecialchars($data['pekerjaan_saksi2']) ?></td></tr>
        </table>
