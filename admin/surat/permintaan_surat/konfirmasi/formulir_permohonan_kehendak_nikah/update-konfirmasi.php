...
mysqli_query($connect, "UPDATE formulir_permohonan_kehendak_nikah SET tanggal_surat = NOW() WHERE id_fpkn = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM formulir_permohonan_kehendak_nikah WHERE id_fpkn = $id");
...
$folder_name = basename(__DIR__); // contoh: formulir_permohonan_kehendak_nikah
