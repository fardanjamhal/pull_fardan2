...
$input_masa = trim($_POST['fmasa_berlaku']); // misalnya: "3" atau "-"
$masa_berlaku_baru = null;

// Jika input bukan '-' dan angka valid, hitung tanggal masa berlaku baru
if ($input_masa !== '-' && is_numeric($input_masa)) {
    $jumlah_hari = (int)$input_masa;
    $masa_berlaku_baru = date('Y-m-d', strtotime("+$jumlah_hari days", strtotime($tanggal_sekarang)));
} else {
    // Tetapkan NULL atau isi default jika tidak dipilih
    $masa_berlaku_baru = null;
}
