          ...
          <tr>
            <td style="width: 160px; vertical-align: top; white-space: nowrap;">
              <div style="display: flex; justify-content: space-between;">
                <span>Tujuan</span><span>:</span>
              </div>
            </td>
            <td style="padding-left: 6px;"><?php echo nl2br($data['tujuan']); ?></td>
          </tr>
          <tr>
            <td style="width: 160px; vertical-align: top; white-space: nowrap;">
              <div style="display: flex; justify-content: space-between;">
                <span>Maksud Untuk</span><span>:</span>
              </div>
            </td>
            <td style="padding-left: 6px;"><?php echo $data['maksud_untuk']; ?></td>
          </tr>
        </table>
        <?php
          } else {
