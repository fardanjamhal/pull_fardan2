<?php
	...
	$qCek = "SELECT * FROM surat_keterangan_penghasilan_orang_tua WHERE no_surat = '$no_surat' AND id_skpot != '$id'";
	...
	$qUpdate 	= "UPDATE surat_keterangan_penghasilan_orang_tua SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_skpot='$id'";
