...
mysqli_query($connect, "UPDATE surat_keterangan_penghasilan_orang_tua SET tanggal_surat = NOW() WHERE id_skpot = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_keterangan_penghasilan_orang_tua WHERE id_skpot = $id");
...
$folder_name = basename(__DIR__); // contoh: surat_keterangan_penghasilan_orang_tua
...
$qUpdate = "
    UPDATE surat_keterangan_penghasilan_orang_tua 
