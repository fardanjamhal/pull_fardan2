      ...
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Keterangan Penghasilan Orang Tua</h2>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_skpotkkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_skpot']) ? (int)$row['id_skpot'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_skpotkkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_keterangan_penghasilan_orang_tua 
                              WHERE id_skpot < $current_id 
                              ORDER BY id_skpot DESC 
                              LIMIT 1
                          ");
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <br><hr style="border-bottom: 1px solid #DCDCDC;">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Nomor Induk Siswa/Mahasiswa</label>
                      <div class="col-sm-9">
                        <input type="text" name="fnomor_induk_siswa" style="text-transform: uppercase;" value="<?php echo $row['nomor_induk_siswa']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                     <div class="form-group">
                      <label class="col-sm-3 control-label">Jurusan / Fakultas / Prodi</label>
                      <div class="col-sm-9">
                        <input type="text" name="fjurusan_fakultas" style="text-transform: uppercase;" value="<?php echo $row['jurusan_fakultas']; ?>" class="form-control" readonly>
                    </div>
                    </div>
                     <div class="form-group">
                      <label class="col-sm-3 control-label">Sekolah/Perguruan Tinggi</label>
                      <div class="col-sm-9">
                        <input type="text" name="fsekolah_perguruan_tinggi" style="text-transform: uppercase;" value="<?php echo $row['sekolah_perguruan_tinggi']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Kelas/Semester</label>
                      <div class="col-sm-9">
                        <input type="text" name="fkelas_semester" style="text-transform: uppercase;" value="<?php echo $row['kelas_semester']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <br><h5 class="box-title pull-right" style="color: #696969;"><i class="fas fa-info-circle"></i> <b>Data Orang Tua</b></h5>
                      <br><hr style="border-bottom: 1px solid #DCDCDC;">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fpenghasilan_ayah" style="text-transform: uppercase;" value="<?php echo $row['penghasilan_ayah']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fpenghasilan_ibu" style="text-transform: uppercase;" value="<?php echo $row['penghasilan_ibu']; ?>" class="form-control" readonly>
                      </div>
                    </div>

                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_skpot']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
