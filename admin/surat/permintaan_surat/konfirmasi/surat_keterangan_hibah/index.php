      ...
      <div class="modal-body">
       ...
       <style>
        ...
        <table class="table" style="width: 100%;">
         <tr>
          <td>Nama Pihak Kedua</td><td>:</td><td><?= htmlspecialchars($data['nama2']) ?></td>
        </tr>
        <tr>
          <td>Tempat & Tanggal Lahir</td><td>:</td><td><?= htmlspecialchars($data['tempat_tgl2']) ?></td>
        </tr>
        <tr>
          <td>Pekerjaan</td><td>:</td><td><?= htmlspecialchars($data['pekerjaan2']) ?></td>
        </tr>
        <tr>
          <td>Alamat</td><td>:</td><td><?= nl2br($data['alamat2']) ?></td>
        </tr>
        <tr>
          <td>Isi Surat</td><td>:</td><td><?= nl2br($data['isi_surat']) ?></td>
        </tr>
        <tr>
          <td>No. SPPT</td><td>:</td><td><?= htmlspecialchars($data['no_sppt']) ?></td>
        </tr>
        <tr>
          <td>Batas Utara</td><td>:</td><td><?= htmlspecialchars($data['tanah_utara']) ?></td>
        </tr>
        <tr>
          <td>Batas Timur</td><td>:</td><td><?= htmlspecialchars($data['tanah_timur']) ?></td>
        </tr>
        <tr>
          <td>Batas Selatan</td><td>:</td><td><?= htmlspecialchars($data['tanah_selatan']) ?></td>
        </tr>
        <tr>
          <td>Batas Barat</td><td>:</td><td><?= htmlspecialchars($data['tanah_barat']) ?></td>
        </tr>
        <tr>
          <td>Kepala Dusun</td><td>:</td><td><?= htmlspecialchars($data['kepala_dusun']) ?></td>
        </tr>
        <tr>
          <td>Saksi 1</td><td>:</td><td><?= htmlspecialchars($data['saksi1']) ?></td>
        </tr>
        <tr>
          <td>Saksi 2</td><td>:</td><td><?= htmlspecialchars($data['saksi2']) ?></td>
        </tr>
        <tr>
          <td>Saksi 3</td><td>:</td><td><?= htmlspecialchars($data['saksi3']) ?></td>
        </tr>
        <tr>
          <td>Saksi 4</td><td>:</td><td><?= htmlspecialchars($data['saksi4']) ?></td>
        </tr>
        </table>
