...
mysqli_query($connect, "UPDATE surat_keterangan_berkelakuan_baik SET tanggal_surat = NOW() WHERE id_skbb = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_keterangan_berkelakuan_baik WHERE id_skbb = $id");
...
$folder_name = basename(__DIR__); // contoh: surat_keterangan_berkelakuan_baik
...
$qUpdate = "
    UPDATE surat_keterangan_berkelakuan_baik 
