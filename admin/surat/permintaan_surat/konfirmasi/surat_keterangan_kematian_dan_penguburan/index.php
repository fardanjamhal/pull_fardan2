              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_skkpkkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_skkp']) ? (int)$row['id_skkp'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_skkpkkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_keterangan_kematian_dan_penguburan 
                              WHERE id_skkp < $current_id 
                              ORDER BY id_skkp DESC 
                              LIMIT 1
                          ");
