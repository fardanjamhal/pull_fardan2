...
mysqli_query($connect, "UPDATE surat_keterangan_kematian_dan_penguburan SET tanggal_surat = NOW() WHERE id_skkp = $id");

// Ambil tanggal_surat terbaru
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_keterangan_kematian_dan_penguburan WHERE id_skkp = $id");
...
$update = mysqli_query($connect, "
  UPDATE surat_keterangan_kematian_dan_penguburan 
