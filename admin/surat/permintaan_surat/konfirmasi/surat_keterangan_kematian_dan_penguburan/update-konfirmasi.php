<?php
	...
	$qCek = "SELECT * FROM surat_keterangan_kematian_dan_penguburan WHERE no_surat = '$no_surat' AND id_skkp != '$id'";
	...
	$qUpdate 	= "UPDATE surat_keterangan_kematian_dan_penguburan SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_skkp='$id'";
