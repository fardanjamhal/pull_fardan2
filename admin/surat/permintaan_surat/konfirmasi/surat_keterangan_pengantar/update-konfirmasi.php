<?php
	...
	$berlaku			= $_POST['fberlaku'];
	$status_surat 		= "SELESAI";

	// Cek apakah no_surat sudah ada untuk surat lain
	$qCek = "SELECT * FROM surat_keterangan_pengantar WHERE no_surat = '$no_surat' AND id_skp != '$id'";
	...
	$qUpdate 	= "UPDATE surat_keterangan_pengantar SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', berlaku='$berlaku', status_surat='$status_surat' WHERE id_skp='$id'";
