              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_skpkkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_skp']) ? (int)$row['id_skp'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_skpkkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_keterangan_pengantar 
                              WHERE id_skp < $current_id 
                              ORDER BY id_skp DESC 
                              LIMIT 1
                          ");
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <select name="fberlaku" class="form-control" required>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fgolongan_darah" style="text-transform: uppercase;" value="<?php echo $row['golongan_darah']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div>
