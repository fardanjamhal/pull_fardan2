              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <?php
                      // Ambil id_skwhkkb dari data surat sekarang (misal dari hasil query sebelumnya)
                      $current_id = isset($row['id_skwh']) ? (int)$row['id_skwh'] : 0;

                      if ($current_id > 0) {
                          // Query nomor surat sebelumnya berdasarkan id_skwhkkb yang kurang dari current_id
                          $query = mysqli_query($connect, "
                              SELECT no_surat 
                              FROM surat_keterangan_wali_hakim 
                              WHERE id_skwh < $current_id 
                              ORDER BY id_skwh DESC 
                              LIMIT 1
                          ");
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                       <!-- Untuk Bootstrap 4 -->
                        <button type="button" class="btn btn-primary btn-sm text-white" data-toggle="modal" data-target="#modalFormulir_<?php echo $row['id_skwh']; ?>">
                        Lihat Data Formulir
                      </button>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_skwh']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
...
<!-- Modal -->
<div class="modal fade" id="modalFormulir_<?php echo $row['id_skwh']; ?>" tabindex="-1">
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php
          // Cek lagi id_skwh ini
          $id_skwh = $row['id_skwh'];
          $query = mysqli_query($connect, "SELECT * FROM surat_keterangan_wali_hakim WHERE id_skwh = '$id_skwh'");
          $data = mysqli_fetch_assoc($query);

          if ($data) {
        ?>
          <table class="table">
            <tr><td>Tempat Menikah :</td><td><?php echo $data['tempat_menikah']; ?></td></tr>
          </table>
        <?php
          } else {
