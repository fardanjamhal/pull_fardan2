<?php
	...
	$qCek = "SELECT * FROM surat_keterangan_wali_hakim WHERE no_surat = '$no_surat' AND id_skwh != '$id'";
	...
	$qUpdate 	= "UPDATE surat_keterangan_wali_hakim SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_skwh='$id'";
