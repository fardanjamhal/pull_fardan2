...
mysqli_query($connect, "UPDATE surat_keterangan_wali_hakim SET tanggal_surat = NOW() WHERE id_skwh = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_keterangan_wali_hakim WHERE id_skwh = $id");
...
$folder_name = basename(__DIR__); // contoh: surat_keterangan_wali_hakim
...
$qUpdate = "
    UPDATE surat_keterangan_wali_hakim 
