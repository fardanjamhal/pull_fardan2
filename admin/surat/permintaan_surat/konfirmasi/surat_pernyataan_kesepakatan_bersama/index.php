      ...
      <div class="modal-body">
       ...
       <style>
        ...
        <table class="table" style="width: 100%;">
         <tr>
            <td>Nama</td><td>:</td><td><?= htmlspecialchars($data['nama2']) ?></td>
          </tr>
          <tr>
            <td>Umur</td><td>:</td><td><?= htmlspecialchars($data['umur2']) ?></td>
          </tr>
          <tr>
            <td>Pekerjaan</td><td>:</td><td><?= htmlspecialchars($data['pekerjaan2']) ?></td>
          </tr>
          <tr>
            <td>Agama</td><td>:</td><td><?= htmlspecialchars($data['agama2']) ?></td>
          </tr>
          <tr>
            <td>Alamat</td><td>:</td><td><?= nl2br(htmlspecialchars($data['alamat2'])) ?></td>
          </tr>
          <tr>
            <td>Isi Surat</td><td>:</td><td><?= nl2br($data['isi_surat']) ?></td>
          </tr>
          <tr>
            <td>Nama Saksi 1</td><td>:</td><td><?= htmlspecialchars($data['saksi1']) ?></td>
          </tr>
          <tr>
            <td>Nama Saksi 2</td><td>:</td><td><?= htmlspecialchars($data['saksi2']) ?></td>
          </tr>
          <tr>
            <td>Nama Saksi 3</td><td>:</td><td><?= htmlspecialchars($data['saksi3']) ?></td>
          </tr>
          <tr>
            <td>Nama Saksi 4</td><td>:</td><td><?= htmlspecialchars($data['saksi4']) ?></td>
          </tr>
