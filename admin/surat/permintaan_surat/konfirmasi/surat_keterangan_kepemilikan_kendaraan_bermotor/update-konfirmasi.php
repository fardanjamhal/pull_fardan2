...
mysqli_query($connect, "UPDATE surat_keterangan_kepemilikan_kendaraan_bermotor SET tanggal_surat = NOW() WHERE id_skkkb = $id");
// ✅ Ambil ulang tanggal_surat yang sudah diperbarui
$qSurat = mysqli_query($connect, "SELECT tanggal_surat FROM surat_keterangan_kepemilikan_kendaraan_bermotor WHERE id_skkkb = $id");
...
$folder_name = basename(__DIR__); // contoh: surat_keterangan_kepemilikan_kendaraan_bermotor
