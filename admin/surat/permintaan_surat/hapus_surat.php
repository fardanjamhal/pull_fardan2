...
if (isset($_GET['id']) && isset($_GET['jenis'])) {
    ...
    $suratMap = [
        ...
        'surat_keterangan_beda_identitas_kis' => ['table' => 'surat_keterangan_beda_identitas_kis', 'id_col' => 'id_skbik'],
        ...
        'surat_keterangan_kematian_dan_penguburan' => ['table' => 'surat_keterangan_kematian_dan_penguburan', 'id_col' => 'id_skkdp'],
        'surat_keterangan_pindah_penduduk' => ['table' => 'surat_keterangan_pindah_penduduk', 'id_col' => 'id_skpp'],
        'surat_keterangan_pengantar_rujuk_atau_cerai' => ['table' => 'surat_keterangan_pengantar_rujuk_atau_cerai', 'id_col' => 'id_skprac'],
        'surat_keterangan_wali_hakim' => ['table' => 'surat_keterangan_wali_hakim', 'id_col' => 'id_skwh'],
        'surat_keterangan_mahar_sunrang' => ['table' => 'surat_keterangan_mahar_sunrang', 'id_col' => 'id_skms'],
        ...
        'surat_keterangan_hibah' => ['table' => 'surat_keterangan_hibah', 'id_col' => 'id_skh']
    ];
