...
<div>
	...
	<div id="isi3">
		...
		<tr>
		<td style="text-align: justify; text-indent: 35px; padding-bottom: 10px;">
			Bahwa yang tersebut namanya di atas benar-benar merupakan seorang janda dari suaminya yang bernama <b><?php echo ucwords(strtolower($row['nama_pasangan'])); ?></b>, yang telah bercerai secara sah pada tanggal <?php echo ucwords(strtolower($row['keterangan_tambahan'])); ?>, dan sampai saat ini yang bersangkutan belum menikah kembali.
		</td>
		</tr>
		<?php endif; ?>
