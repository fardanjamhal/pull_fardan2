...
<div>
	...
	<div id="isi3">
		...
		<tr>
			...
			Bahwa yang tersebut namanya diatas benar-benar Masih Hidup dan bertempat tinggal di <?php
				include_once '../../../surat/cetak/helper/alamat_helper.php';

				// Pastikan $row sudah berisi data dari database sebelumnya
				echo formatAlamatLengkap($row, $connect); // ✅ benar
				?>, serta hingga saat ini yang bersangkutan masih dalam keadaan hidup.
			</td>
		</tr>
		<tr>
