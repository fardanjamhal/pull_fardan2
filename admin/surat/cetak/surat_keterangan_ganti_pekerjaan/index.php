...
<div>
	...
	<div id="isi3">
		...
		<tr>
			<td style="text-align: justify;">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Benar yang Namanya tersebut diatas adalah warga 
				<?php
				// Pastikan $row sudah berisi data dari database sebelumnya
				echo formatAlamatLengkap($row, $connect); // ✅ benar
				?>, Surat Keterangan ini diberikan kepada yang bersangkutan untuk mengurus perbahan status pekerjaan Pada KK dan KTP dari sebelumnya <?php echo '<strong>' . ucwords(strtolower($row['pekerjaan'])) . '</strong>'; ?> menjadi <?php echo '<strong>' . ucwords(strtolower($row['pekerjaan_sekarang'])) . '</strong>'; ?>.
			</td>
		</tr>
		</table>
	</div>
