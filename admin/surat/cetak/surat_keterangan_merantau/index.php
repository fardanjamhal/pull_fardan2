...
<div>
	...
	<div id="isi3">
		...
		<tr>
			...
			Bahwa yang tersebut namanya diatas benar-benar keluar daerah/merantau di <b><?php echo ucwords(strtolower($row['daerah'])); ?></b> untuk <b><?php echo ucwords(strtolower($row['alasan_merantau'])); ?></b>  sampai pada saat dikeluarkannya surat keterangan ini.
			</td>
		</tr>
		<tr>
