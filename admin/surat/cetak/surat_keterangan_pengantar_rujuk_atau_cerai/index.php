...
<div>
	...
	<div id="isi3">
		...
		<tr>
			...
			<span style="text-transform: capitalize;">
				<?php echo $rows['kota']; ?>
			</span>, menerangkan bahwa berdasarkan keterangan dari :
			</td>
		</tr>
		</table>
		<br><br>
		<table width="100%" style="text-transform: capitalize;">
			...
			<tr>
				...
				<td>:</td>
				<td style="text-transform: uppercase;"><?php echo $row['bin']; ?></td>
			</tr>
			<?php
			...
			<tr>
				<td class="indentasi">6. Pekerjaan</td>
				<td>:</td>
				<td style="text-transform: uppercase;"><?php echo $row['pekerjaan']; ?></td>
			</tr>
			<td class="indentasi">7. Tempat Tinggal</td>
			<td>:</td>
			<td style="text-align: justify;">
				<?php
		...
		<table width="100%" style="text-transform: capitalize;">
			<br>
			<tr>
				<td width="30%" class="indentasi">8. Nama Lengkap</td>
				<td width="2%">:</td>
			...
			<tr>
				<td class="indentasi">9. Binti</td>
				<td>:</td>
				<td><?php echo strtoupper($row['binti2']); ?></td>
			</tr>
			
			<tr>
				<td class="indentasi">10. Tempat / Tanggal Lahir </td>
				<td>:</td>
				<td><?php echo strtoupper($row['tempat_tgl_lahir2']); ?></td>
			</tr>
			<tr>
				<td class="indentasi">11. Kewarganegaraan</td>
				<td>:</td>
				<td style="font-weight:">
					<?php echo strtoupper($row['kewarganegaraan2']); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>:</td>
				<td style="text-transform: uppercase;"><?php echo $row['agama2']; ?></td>
			</tr>
			<tr>
				<td class="indentasi">13. Pekerjaan</td>
				<td>:</td>
				<td style="text-transform: uppercase;"><?php echo $row['pekerjaan2']; ?></td>
			</tr>
			<tr>
				<td class="indentasi">14. Alamat</td>
				<td>:</td>
				<td style="text-transform: uppercase;"><?php echo $row['alamat2']; ?></td>
			</tr>
