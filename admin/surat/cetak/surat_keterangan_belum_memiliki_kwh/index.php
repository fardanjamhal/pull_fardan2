...
<div>
	...
	<div id="isi3">
		...
		<tr>
			...
			Bahwa yang tersebut namanya diatas benar-benar Belum memiliki <b>KWH/METER Listrik</b> yang berdomosili <?php
				include_once '../../../surat/cetak/helper/alamat_helper.php';

				// Pastikan $row sudah berisi data dari database sebelumnya
				echo formatAlamatLengkap($row, $connect); // ✅ benar
				?> sampai pada saat dikeluarkannya surat keterangan ini.
			</td>
		</tr>
		<tr>
