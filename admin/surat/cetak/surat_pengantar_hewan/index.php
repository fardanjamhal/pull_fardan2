<?php 
	...
	$qCek = mysqli_query($connect,"
		SELECT arsip_surat.*, surat_pengantar_hewan.*, surat_pengantar_hewan.id_arsip 
		FROM surat_pengantar_hewan 
		LEFT JOIN arsip_surat ON arsip_surat.id_arsip = surat_pengantar_hewan.id_arsip 
		WHERE surat_pengantar_hewan.id_sph = '$id'
	");
	...
	<div id="isi3">
		...
		<table width="100%" style="text-transform: capitalize;">
			...
			<tr>
				...
				<td width="2%">:</td>
				<td width="68%"><strong><?php echo htmlspecialchars($nama_pejabat); ?></strong></td>
			</tr>
			...
			?>
			<tr>
				<td width="30%" style="padding-left: 40px;">Tempat/Tgl. Lahir</td>
				<td>:</td>
				<td>
				<?php 
			...
			<tr>
				<td width="30%" style="padding-left: 40px;">Agama</td>
				<td>:</td>
		...
		<tbody>
			<tr>
			<td>1</td>
			<td><?php echo strtoupper($row['nama_hewan']); ?></td>
			<td><?php echo strtoupper($row['jenis_kelamin_hewan']); ?></td>
			<td><?php echo strtoupper($row['umur']); ?></td>
			<td><?php echo strtoupper($row['warna_bulu']); ?></td>
			<td><?php echo strtoupper($row['tanduk']); ?></td>
			</tr>
		</tbody>
		</table>
		<br>
		<table width="100%">
			<tr>
				<td width="10%" style="padding-left: 10px;"><strong>Tujuan</strong></td>
				<td>:</td>
				<td><?php echo strtoupper($row['tujuan']); ?></td>
			</tr>
			<tr>
				<td width="10%" style="padding-left: 10px;"><strong>Untuk</strong></td>
				<td>:</td>
				<td><?php echo strtoupper($row['untuk']); ?></td>
			</tr>
		</table>
	...
	<table width="100%" style="text-transform: capitalize;">
		...
		<tr>
			...
			<?php
					...
					// Termasuk id_pejabat_desa dari tabel surat_pengantar_hewan
