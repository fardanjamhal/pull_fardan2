<?php 
	...
	$qCek = mysqli_query($connect,"
		SELECT arsip_surat.*, surat_keterangan_perhiasan.*, surat_keterangan_perhiasan.id_arsip 
		FROM surat_keterangan_perhiasan 
		LEFT JOIN arsip_surat ON arsip_surat.id_arsip = surat_keterangan_perhiasan.id_arsip 
		WHERE surat_keterangan_perhiasan.id_skp = '$id'
	");
	...
	<table width="100%" style="text-transform: capitalize;">
		...
		<tr>
			...
			<?php
					...
					// Termasuk id_pejabat_desa dari tabel surat_keterangan_perhiasan
