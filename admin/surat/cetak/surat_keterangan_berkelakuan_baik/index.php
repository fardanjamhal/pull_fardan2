...
<div>
	...
	<tr>
		<td class="indentasi" style="text-align: justify;">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Berdasarkan pengamatan kami, yang bersangkutan selama ini tidak pernah terlibat dalam permasalahan hukum maupun urusan kepolisian, baik secara langsung maupun tidak langsung. 
			Surat keterangan ini dibuat untuk keperluan <b><?php echo htmlspecialchars($row['keperluan']); ?></b>.
		</td>
	</tr>
</table>
<br>
	...
	<table width="100%" style="text-transform: capitalize;">
		...
		<tr>
			...
			<?php
					...
					// Termasuk id_pejabat_desa dari tabel surat_keterangan_berkelakuan_baik
					$qCek = mysqli_query($connect, "SELECT penduduk.*, surat_keterangan_berkelakuan_baik.* FROM penduduk LEFT JOIN surat_keterangan_berkelakuan_baik ON surat_keterangan_berkelakuan_baik.nik = penduduk.nik WHERE surat_keterangan_berkelakuan_baik.id_skbb='$id'");
