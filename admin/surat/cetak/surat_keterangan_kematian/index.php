<?php 
	...
	$qCek = mysqli_query($connect,"
		SELECT arsip_surat.*, surat_keterangan_kematian.*, surat_keterangan_kematian.id_arsip 
		FROM surat_keterangan_kematian 
		LEFT JOIN arsip_surat ON arsip_surat.id_arsip = surat_keterangan_kematian.id_arsip 
		WHERE surat_keterangan_kematian.id_skk = '$id'
	");
