<?php 
	...
	$qCek = mysqli_query($connect,"
		SELECT arsip_surat.*, surat_keterangan_pengantar.*, surat_keterangan_pengantar.id_arsip 
		FROM surat_keterangan_pengantar 
		LEFT JOIN arsip_surat ON arsip_surat.id_arsip = surat_keterangan_pengantar.id_arsip 
		WHERE surat_keterangan_pengantar.id_skp = '$id'
	");
	...
	<div id="isi3">
		...
		<table width="100%" style="text-transform: capitalize;">
			...
			<tr>
				...
				<td>:</td>
				<td style="text-transform: uppercase;"><?php echo ucwords(strtolower($row['berlaku'])); ?></td>
			</tr>
			<tr>
