...
<div>
	...
	<div id="isi3">
		...
		<tr>
			...
			Bahwa yang tersebut namanya diatas benar-benar <b>BELUM MENIKAH</b>  sampai pada saat dikeluarkannya Surat Keterangan ini.
			</td>
		</tr>
		<tr>
            ...
            if ($id_pejabat_desa == 1) {
              ...
              if (isset($pejabat_data[1])) {
                $url_gambar = htmlspecialchars($pejabat_data[2]['nama']);
                 echo "<img src=\"../helper/generate_qr_surat.php?id=$id_surat&jenis=$jenis_surat\" width=\"85\" alt=\"QR Code\" style=\"margin: -90px auto 5px; \">";
                echo "<br>";
              } else {
