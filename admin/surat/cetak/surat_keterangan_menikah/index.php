	...
	<div id="isi3">
		...
		<tr>
			...
			<td style="text-align: justify;">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Yang bertanda tangan di bawah ini adalah Pemerintah
				<span style="text-transform: capitalize;"><?php echo $nama_desa; ?></span> Kecamatan 
				<span style="text-transform: capitalize;"><?php echo ucwords($kecamatan); ?></span> Kabupaten 
				<span style="text-transform: capitalize;"><?php echo ucwords($kota); ?></span> menerangkan bahwa:
			</td>
		</tr>
		</table>
		<br>
		...
		<br>
		<td>
			&nbsp;&nbsp;&nbsp;&nbsp;Benar bahwa nama yang tersebut diatas adalah suami dari nama tersebut di bawah ini:
		</td>
		<br><br>
		<table width="100%" style="margin-left: 40px;">
			<tr>
				<td width="30%" class="indentasi">Nama</td>
				<td width="2%">:</td>
				<td width="68%" style="text-transform: uppercase; font-weight: bold;"><?php echo $row['nama_pelapor']; ?></td>
			</tr>
			<?php
				$tgl_lhr = date($row['tgl_lahir']);
				$tgl = date('d ', strtotime($tgl_lhr));
			...
			<tr>
				<td class="indentasi">Tempat / Tanggal Lahir</td>
				<td>:</td>
				<td><?php echo ucwords(strtolower($row['tanggal_lahir_pelapor'])) . ", " . $tgl . ucwords(strtolower($blnIndo[$bln])) . $thn; ?></td>
			</tr>
			<tr>
				<td class="indentasi">NIK</td>
				<td>:</td>
			...
			<tr>
				<td class="indentasi">Jenis Kelamin</td>
				<td>:</td>
				<td><?php echo ucwords(strtolower($row['jenis_kelamin_pelapor'])); ?></td>
			</tr>
			<tr>
				<td class="indentasi">Pekerjaan</td>
				<td>:</td>
		...
		<table width="100%" style="text-align: justify;">
			<tr>
				<td class="indentasi">&nbsp;&nbsp;&nbsp;&nbsp;Adalah benar warga <?php
				include_once '../../../surat/cetak/helper/alamat_helper.php';

				// Pastikan $row sudah berisi data dari database sebelumnya
				echo formatAlamatLengkap($row, $connect); // ✅ benar
				?> yang telah secara sah melangsungkan pernikahan pada:</td>
			</tr>
		</table>
		<br>
		<table width="100%" style="margin-left: 40px;">
			<tr>
				...
				<td width="68%">
					<?php
					echo !empty($row['tanggal_nikah']) 
						? formatTanggalIndoLengkap($row['tanggal_nikah']) 
						: '-';
					?>
				</td>
			</tr>
			...
			<tr>
				...
				<td width="2%">:</td>
				<td width="68%"><?php echo $row['wali_nikah']; ?></td>
			</tr>
		</table>
		<br>
		<table width="100%" style="text-align: justify;">
