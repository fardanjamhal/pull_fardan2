...
<div>
	...
	<table width="100%" style="text-transform: capitalize;">
		...
		<tr>
			<td></td>
			<td align="center" style="text-transform: uppercase"><b><u><br><?php echo $row['nama']; ?></u></b></td>
			<td></td>
				...
				if (isset($pejabat_data[$id_pejabat_desa])) {
					...
					if (isset($pejabat_data[1])) {
						$url_gambar = htmlspecialchars($pejabat_data[2]['nama']);
						 echo "<img src=\"../helper/generate_qr_surat.php?id=$id_surat&jenis=$jenis_surat\" width=\"90\" alt=\"QR Code\" style=\"margin: -99px auto 2px; \">";
						echo "<br>";
					} else {
