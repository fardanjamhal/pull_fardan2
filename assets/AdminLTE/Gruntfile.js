...
module.exports = function (grunt) { // jshint ignore:line
        ...
        less: {
            ...
            skins: {
                files: {
                    ...
                    'dist/css/skins/skin-bg-blue.css': 'build/less/skins/skin-bg-blue.less',
            ...
            toSass: {
                files: {
                    'dist/scss/AdminLTE.scss': 'build/less/AdminLTE.less',
                    'dist/scss/skins/skin-bg-blue.scss': 'build/less/skins/skin-bg-blue.less'
                }
            },
            // Skins minified
            minifiedSkins: {
                ...
                files: {
                    'dist/css/skins/skin-bg-blue.min.css': 'build/less/skins/skin-bg-blue.less',
    ...
    // CSS Task
    grunt.registerTask('css', ['less:development', 'less:production', 'less:skins', 'less:minifiedSkins', 'less:toSass', 'replace']);
