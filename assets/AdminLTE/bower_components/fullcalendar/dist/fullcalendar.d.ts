declare module "fullcalendar/src/util" {
  ...
  export function computeDurationGreatestUnit(
    duration: any,
    durationInput: any,
  ): any;
...
declare module "fullcalendar/EventDef" {
  ...
  } from "fullcalendar/ParsableModelMixin";
...
declare module "fullcalendar/src/models/event/util" {
  ...
  export function eventDefsToEventInstances(
    eventDefs: any,
    unzonedRange: any,
  ): any[];
...
declare module "fullcalendar/src/types/input-types" {
  ...
  export type EventSourceSimpleInput =
    | EventObjectInput[]
    | EventSourceFunction
    | string;
  export interface EventSourceExtendedInput
...
declare module "fullcalendar/src/exports" {
  ...
  } from "fullcalendar/src/date-formatting";
  ...
  export {
    ...
    EmitterInterface,
  } from "fullcalendar/EmitterMixin";
  export {
    default as ListenerMixin,
    ListenerInterface,
  } from "fullcalendar/ListenerMixin";
...
declare module "fullcalendar/src/types/jquery-hooks" {
  ...
  global {
    ...
    interface JQuery {
      ...
      fullCalendar(
        method: "refetchEventSources",
        sourceMultiQuery: any,
      ): JQuery;
    }
  }
}
