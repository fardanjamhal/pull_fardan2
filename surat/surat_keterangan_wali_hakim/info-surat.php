			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="container-fluid">
						<div class="row">
							<a class="col-sm-6"><h5><b>SURAT KETERANGAN PENGANTAR</b></h5></a>
					...
					<form method="post" action="simpan-surat.php">
						...
						<div class="row">
							...
							<div class="col-sm-6">
							    <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Akan menikah di :</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="ftempat_menikah" class="form-control" style="text-transform: capitalize;" placeholder="KUA Kecamatan Kabupaten" required>
						           	</div>
						        </div>
							</div>
						</div>
