					...
					<div class="card">
						...
						<form method="post" action="simpan-surat.php">
							...
							<div class="row">
								...
								<h6 class="container-fluid" align="right"><i class="fas fa-edit"></i>Data Kematian&nbsp;&nbsp;&nbsp;</h6><hr width="97%">
								<div class="col-sm-6">
									<div class="form-group">
										<label class="col-sm-12" style="font-weight: 500;">Hari / Tanggal</label>
										<div class="col-sm-12">
											<input type="text" name="fhari_tanggal_kematian" class="form-control" style="text-transform: capitalize;" placeholder="Hari / Tanggal Kematian.." required>
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label class="col-sm-12" style="font-weight: 500;">Jam / Pukul</label>
										<div class="col-sm-12">
											<input type="text" name="fjam_pukul" class="form-control" style="text-transform: capitalize;" placeholder="Jam / Pukul.." required>
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										...
										<div class="col-sm-12">
											<input type="text" name="ftempat" class="form-control" style="text-transform: capitalize;" placeholder="Tempat.." required>
										</div>
									</div>
								</div>
								<div class="col-sm-6">
								...
								<h6 class="container-fluid" align="right"><i class="fas fa-edit"></i>Dikuburkan / Dikebumikan pada :&nbsp;&nbsp;&nbsp;</h6><hr width="97%">
								<div class="col-sm-6">
									<div class="form-group">
										<label class="col-sm-12" style="font-weight: 500;">Hari / Tanggal Dikebumikan</label>
										<div class="col-sm-12">
											<input type="text" name="fhari_tanggal_dikebumikan" class="form-control" style="text-transform: capitalize;" placeholder="Hari / Tanggal Dikebumikan.." required>
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label class="col-sm-12" style="font-weight: 500;">Jam / Pukul Dikebumikan</label>
										<div class="col-sm-12">
											<input type="text" name="fjam_pukul_dikebumikan" class="form-control" style="text-transform: capitalize;" placeholder="Jam / Pukul Dikebumikan.." required>
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label class="col-sm-12" style="font-weight: 500;">Tempat Dikebumikan</label>
										<div class="col-sm-12">
											<input type="text" name="ftempat_dikebumikan" class="form-control" style="text-transform: capitalize;" placeholder="Tempat Dikebumikan.." required>
										</div>
									</div>
								</div>
