			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="container-fluid">
						<div class="row">
							<a class="col-sm-6"><h5><b>SURAT KETERANGAN BELUM TERBIT SPPT/PBB</b></h5></a>
					...
					<form method="post" action="simpan-surat.php">
						...
						<br>
						<h6 class="container-fluid" align="left"><i class="fas fa-edit"></i> INFORMASI TANAH PERTANIAN/NON PERTANIAN </h6><hr width="97%">
						<div class="row px-3">
						<div class="col-sm-12">
							<div class="form-group">
							<label for="flokasi" style="font-weight: 500;">LOKASI TANAH <br>
							</label>
							<input type="text" name="flokasi" id="flokasi" class="form-control" style="text-transform: capitalize;" placeholder="Dusun Desa Kecamatan Kabupaten / Kota" required>
							</div>
						</div>
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<input type="text" name="ftanah_utara" id="ftanah_utara" class="form-control"
													style="text-transform: capitalize;" placeholder="Nama Pemilik Tanah">
											</div>
										</div>
