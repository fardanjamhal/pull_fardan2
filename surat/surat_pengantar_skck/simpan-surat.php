<?php
    ...
    if ($dataPenduduk) {
        ...
        $qTambahSurat = "INSERT INTO surat_pengantar_skck (jenis_surat, nik, bukti_ktp, bukti_kk, keperluan, keterangan, status_surat, id_profil_desa, id_arsip) VALUES('$jenis_surat', '$nik', '$bukti_ktp', '$bukti_kk', '$keperluan', '$keterangan', '$status_surat', '$id_profil_desa', '$id_arsip')";
