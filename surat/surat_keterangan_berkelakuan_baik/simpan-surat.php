<?php
    ...
    if ($dataPenduduk) {
        ...
        $qTambahSurat = "INSERT INTO surat_keterangan_berkelakuan_baik (jenis_surat, nik, keperluan, status_surat, id_profil_desa, id_arsip) VALUES('$jenis_surat', '$nik', '$keperluan', '$status_surat', '$id_profil_desa', '$id_arsip')";
