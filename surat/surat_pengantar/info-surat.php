			...
			<div class="col-md-12">
				<div class="card">
					...
					<form method="post" action="simpan-surat.php">
						...
						<div class="col-sm-6">
						<div class="form-group">
							<label class="col-sm-12" style="font-weight: 500;">Tujuan</label>
							<div class="col-sm-12">
							<div class="input-group">
								<input type="text" id="ftujuan" name="ftujuan" class="form-control" placeholder="Contoh : Kantor DPM PTSP Kab. Jeneponto" required>
								<div class="input-group-append">
								<button type="button" class="btn btn-outline-secondary" style="width: 40px;" onclick="isiDefaultTujuan()">
						...
						<div class="col-sm-6">
						<div class="form-group">
							<label class="col-sm-12" style="font-weight: 500;">Maksud untuk</label>
							<div class="col-sm-12">
							<div class="input-group">
								<input type="text" id="fmaksud_untuk" name="fmaksud_untuk" class="form-control" placeholder="Contoh : Mengurus Izin Pembentukan Badan Usaha Dagang dan Perbengkelan" required>
								<div class="input-group-append">
								<button type="button" class="btn btn-outline-secondary" style="width: 40px;" onclick="isiDefaultMaksud()">
									<i class="fas fa-sync-alt"></i>
								</button>
								</div>
							</div>
						...
						<!-- Tambahkan fungsi JS -->
						<script>
						function isiDefaultTujuan() {
							document.getElementById('ftujuan').value = 'Kantor DPM PTSP Kab. Jeneponto';
						}
