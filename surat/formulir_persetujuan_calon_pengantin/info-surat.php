						...
						<div class="row">
						  	<div class="col-sm-12">
								...
								<style>
									...
									#list_nik_istri .list-group-item {
										cursor: pointer;
										padding: 8px 12px;
									}

									#list_nik_istri .list-group-item:hover {
										background: #007bff;
										color: white;
									}
								</style>
						...
						<script src="../../helper/helper-validasi-nik.js"></script>
								...
								<div class="form-group mb-3 position-relative">
									<div class="col-sm-12">
										...
										<div id="list_nik_istri" class="list-group" 
									...
									$('#fnik_istri').keyup(function(){
										...
										$.get('../helper/search_penduduk.php?q=' + q, function(res){
											...
											data.forEach(function(item){
												html += `<a href="#" class="list-group-item list-group-item-action pilih-nik-istri"
															data-nik="${item.nik}">
															${item.text}
														</a>`;
											});

											$('#list_nik_istri').html(html).show();
										});
									});

									// Klik salah satu pilihan
									$(document).on('click', '.pilih-nik-istri', function(e){
										e.preventDefault();
