<?php
    ...
    if (isset($_POST['submit'])){
        ...
        $qTambahSurat = "INSERT INTO formulir_permohonan_kehendak_nikah (jenis_surat, nik, kepada_yth, calon_suami, calon_istri, hari_tanggal, tempat_akad, delapan, sembilan, sepuluh, sebelas, dua_belas, tiga_belas, status_surat, id_profil_desa) VALUES('$jenis_surat', '$nik', '$kepada_yth', '$calon_suami', '$calon_istri', '$hari_tanggal', '$tempat_akad', '$delapan', '$sembilan', '$sepuluh', '$sebelas', '$dua_belas', '$tiga_belas', '$status_surat', '$id_profil_desa')";
