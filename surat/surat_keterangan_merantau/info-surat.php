			...
			<div class="col-md-12">
				<div class="card">
					...
					<form method="post" action="simpan-surat.php">
						...
						<div class="col-sm-6">
						<div class="form-group">
							<label class="col-sm-12" style="font-weight: 500;">Daerah yang dituju</label>
							<div class="col-sm-12">
							<div class="input-group">
								<input type="text" id="fdaerah" name="fdaerah" class="form-control" placeholder="isi kab / kota" required>
							</div>
							</div>
						</div>
						</div>
						...
						<div class="col-sm-6">
						<div class="form-group">
							<label class="col-sm-12" style="font-weight: 500;">Alasan Merantau</label>
							<div class="col-sm-12">
							<div class="input-group">
								<input type="text" id="falasan_merantau" name="falasan_merantau" class="form-control" placeholder="Isi alasan merantau" required>
							</div>
							</div>
						</div>
						</div>
