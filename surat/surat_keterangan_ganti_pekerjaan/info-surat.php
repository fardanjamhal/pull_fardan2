				...
				<div class="card">
					...
					<form method="post" action="simpan-surat.php">
						...
						<div class="row">
							...
							<div class="col-sm-6">
							    <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Pekerjaan Sebelumnya</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fjenis_usaha" class="form-control" style="text-transform: capitalize;" value="<?php echo $data['pekerjaan']; ?>" readonly>
						           	</div>
						        </div>
							</div>
							<div class="col-sm-6">
							    <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Pekerjaan Saat Ini</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fpekerjaan_sekarang" class="form-control" style="text-transform: capitalize;" placeholder="isi pekerjaan baru" required>
						           	</div>
						        </div>
							</div>
						</div>
