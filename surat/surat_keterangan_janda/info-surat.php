			...
			<div class="col-md-12">
				<div class="card">
					...
					<form method="post" action="simpan-surat.php">
						...
						<div class="col-sm-6">
						<div class="form-group">
							<label class="col-sm-12" style="font-weight: 500;">Nama Suami</label>
							<div class="col-sm-12">
							<div class="input-group">
								<input type="text" id="fnama_pasangan" name="fnama_pasangan" class="form-control" placeholder="Masukkan Nama Suami" required>
							</div>
							</div>
						</div>
						</div>
						...
						<div class="col-sm-6">
						<div class="form-group">
							<label class="col-sm-12" style="font-weight: 500;">Penyebab Status Janda</label>
							<div class="col-sm-12">
							<div class="input-group">
								<select id="falasan_pisah" name="falasan_pisah" class="form-control" required>
						...
						<div class="col-sm-6">
						<div class="form-group">
							<label class="col-sm-12" style="font-weight: 500;">Tanggal Meninggal atau Cerai</label>
							<div class="col-sm-12">
							<div class="input-group">
								<input type="text" id="fketerangan_tambahan" name="fketerangan_tambahan" class="form-control" placeholder="Contoh : 21 Agustus 2021" required>
							</div>
							</div>
						</div>
						</div>
