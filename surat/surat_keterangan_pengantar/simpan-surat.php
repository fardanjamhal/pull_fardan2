<?php
    ...
    if ($dataPenduduk) {
        ...
        $qTambahSurat = "INSERT INTO surat_keterangan_pengantar (jenis_surat, nik, keperluan, golongan_darah, status_surat, id_profil_desa, id_arsip) VALUES('$jenis_surat', '$nik', '$keperluan', '$golongan_darah', '$status_surat', '$id_profil_desa', '$id_arsip')";
