				...
				<div class="card">
					...
					<form method="post" action="simpan-surat.php">
						...
						<div class="row">
							...
							<div class="col-sm-6">
							    <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Golongan Darah</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fgolongan_darah" class="form-control" style="text-transform: capitalize;" placeholder="A / B / AB / O" required>
						           	</div>
						        </div>
							</div>
						</div>
