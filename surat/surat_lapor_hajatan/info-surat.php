			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="container-fluid">
						<div class="row">
							<a class="col-sm-6"><h5><b>SURAT LAPOR HAJATAN</b></h5></a>
					...
					<form method="post" action="simpan-surat.php">
						...
						<hr width="97%">
						<div class="container-fluid">
		                	<input type="button" class="btn btn-warning" value="Batal" onclick="window.location.href='../../surat/surat_lapor_hajatan/'">
