<?php
    ...
    if ($dataPenduduk) {
        ...
        $qTambahSurat = "INSERT INTO surat_keterangan_perhiasan (jenis_surat, nik, jenis_perhiasan, nama_perhiasan, berat, toko_perhiasan, lokasi_toko_perhiasan, keperluan, status_surat, id_profil_desa, id_arsip) VALUES('$jenis_surat', '$nik', '$jenis_perhiasan', '$nama_perhiasan', '$berat', '$toko_perhiasan', '$lokasi_toko_perhiasan', '$keperluan', '$status_surat', '$id_profil_desa', '$id_arsip')";
