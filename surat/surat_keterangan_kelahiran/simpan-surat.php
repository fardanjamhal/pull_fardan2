<?php
    ...
    if (isset($_POST['submit'])){
        ...
        $ttl_bayi          = addslashes($_POST['fttl_bayi']);
        $jenis_kelamin     = addslashes($_POST['fjenis_kelamin_bayi']);
        $agama             = addslashes($_POST['fagama_bayi']);
        $alamat            = addslashes($_POST['falamat_bayi']);
